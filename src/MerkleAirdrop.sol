...
contract MerkleAirdrop is EIP712 {
    ...
    IERC20 private immutable i_airdropGToken;
    mapping(address claimer => bool claimed) private s_hasClaimed;

    constructor(
        bytes32 merkleRoot,
        IERC20 airdropGToken
    ) EIP712("MerkleAirdrop", "1") {
        i_airdropGToken = airdropGToken;
    ...
    function claim(
        ...
        i_airdropGToken.safeTransfer(account, amount);
    }
